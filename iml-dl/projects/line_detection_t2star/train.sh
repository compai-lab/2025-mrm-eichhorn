...
output_filename="$code_directory/iml-dl/results/line_detection_t2star/logs/log_${timestamp}.txt"
...
nohup python -u ./core/Main.py --config_path ./projects/line_detection_t2star/configs/config_train.yaml > "$output_filename" &
