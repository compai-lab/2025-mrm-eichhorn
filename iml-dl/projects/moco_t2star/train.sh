...
output_filename="$code_directory/iml-dl/results/moco_t2star/logs/log_${timestamp}.txt"
...
nohup python -u ./core/Main.py --config_path ./projects/moco_t2star/configs/config_test.yaml > "$output_filename" &
